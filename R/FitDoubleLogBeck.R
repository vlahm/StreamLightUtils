#' A standalone version of the FitDoubleLogBeck function from the greenbrown package.
#'
#' @description This is a standalone version of the FitDoubleLogBeck function from
#' the greenbrown package.
#'
#' Reference information
#' Forkel M, Wutzler T (2015) greenbrown - land surface phenology and trend analysis.
#' A package for the R software. Version 2.2, 2015-04-15, http://greenbrown.r-forge.r-project.org/
#'
#' @keywords internal

#===============================================================================
#Standalone FitDoubleLogBeck function from the greenbrown package
#Forkel M, Wutzler T (2015) greenbrown - land surface phenology and trend analysis.
#A package for the R software. Version 2.2, 2015-04-15, http://greenbrown.r-forge.r-project.org/.
#https://github.com/rforge/greenbrown/tree/master/pkg/greenbrown/R
#===============================================================================
